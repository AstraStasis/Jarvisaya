...
from tools import (
    ...
    control_media, get_system_diagnostics,
...
system_instruction = (
    ...
    "unless the action is destructive (e.g. restart, shutdown). "
    ...
    "close all windows, and shut down the PC. "
...
from tools import shutdown_pc, close_all_windows
